...
public class TileBag {
	...
	public Tile drawTile() {
		...
		for(int i = 0; i < this.bag.length; i++) { //Go through the whole bag and copy it in the new set without the drawn tile
			if (i < randomPosition) {
	...
	public String toString() {
		...
		for(Tile tile : this.bag) {
			list += "L: " + tile.getLetter() + ", V: " + tile.getValue() + "; "; // L stands for letter, V for value
		}
		return list;
	}
